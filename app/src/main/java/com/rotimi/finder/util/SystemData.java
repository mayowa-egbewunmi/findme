...
/**
 * Created by oladapo on 19/09/2016.
 * as part of com.softcom.tndn.utils in TNDN
 */
public class SystemData {

    public static final String PREF_FILE = "NPDN_Shared_Prefs";
    private SharedPreferences settings;
    private SharedPreferences.Editor editor;


    public SystemData(Context ctx) {
        //settings = act.getSharedPreferences(PREF_FILE, Context.MODE_PRIVATE);
